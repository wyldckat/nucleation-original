...
# Revision 11, march 17, 2010, Single script and mirror selector by Fabio
# Revision 10, march 16, 2010, Fix bashims and architeture check by Fabio
# Revision 09, march 15, 2010, New fixup section by Bruno
# Revision 08, january 27 , 2010, changed fixup to be more general - I hope
...
mkdir OpenFOAM
cd OpenFOAM
echo "Your system appears to be Ubuntu 9.10. Acting accordingly"
